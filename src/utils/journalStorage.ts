    ...
    const sampleJournals: Journal[] = [
      {
        id: '1',
        title: '清晨的远山与呼吸',
        content: '今天的雾气格外的重。站在露台上，我几乎看不清远处的松林。但这正是我需要的，一种被世界暂时隔离的静谧感。煮了一壶茶，茶香在空气中弥漫，与雾气交织在一起，仿佛置身于仙境。这样的早晨，让我重新感受到了生活的美好。',
        mood: '平静',
        category: '生活',
        date: '2023-10-22',
      ...
      },
      {
        id: '2',
        title: '重拾身体的韵律',
        content: '很久没有进行深度拉伸了。每一个关节的舒展都伴随着微微的酸痛，但之后是前所未有的轻盈。专注力也随之回归，仿佛找回了与身体的连接。运动不仅是对身体的锻炼，更是对心灵的净化。',
        mood: '专注',
        category: '健康',
        date: '2023-10-20',
